...
// import { key_token,iv_token } from '../resource';
...
export class DateConverter implements AttributeConverter<Date,string>{
    to(data: Date): string {
        return `${data.toLocaleDateString('default',{year: 'numeric'})}/${data.toLocaleDateString('default',{month: '2-digit'})}/${data.toLocaleDateString('default',{day: '2-digit'})}`;
    }
