...
public class GroupNoteDTO implements GroupNoteDTOInterface {
    ...
    public GroupNoteDTO(UUID id, String username, String avatar, Boolean isMember, Role roleMember) {
        this.id = id;
    ...
    public static class builder {
        ...
        public GroupNoteDTO build() {
            return new GroupNoteDTO(id,username,avatar,isMember,roleMember);
        }
    }
}
