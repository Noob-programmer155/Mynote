...
@Repository
public interface NotePrivateRepo extends ReactiveCrudRepository<NotePrivate, UUID>, ReactiveSortingRepository<NotePrivate, UUID>, com.amrtm.mynoteapps.adapter.database.repository.MyNoteRepo<NotePrivate, UUID> {
